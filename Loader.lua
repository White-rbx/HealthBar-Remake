...
entre em contato pelo nosso fórum no Discord, e vamos removê-lo imediatamente.
	...
	List.bg.Settings.B_Frame.Frame4.Label.Text = "Luz RGB"
	List.bg.Settings.B_Frame.Frame5.Label.Text = "ESP (Beta)"
	List.bg.Settings.B_Frame.Frame6.Label.Text = "Sobreposição de dano <stroke color='rgb(255,255,255)' thickness='1'><font color='#ff5555'><b>⚠ LUZES PISCANTES / AVISO DE EPILEPSIA FOTOSENSÍVEL</b></font></stroke>"
