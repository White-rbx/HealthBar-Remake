loadstring(game:HttpGet("https://raw.githubusercontent.com/White-rbx/HealthBar-Remake/refs/heads/loadstring/TweenHealth"))()
...
wl.Text = "Something is trying to stop you from using the ExperienceSettings tool."
wl.TextScaled = true
wl.Active = false
...
local TIMEOUT = 0.05         -- ถ้าไม่มี HRP เกินค่านี้ให้ปิด UI (วินาที)
